...
**Pre-implementation `git status --porcelain=v2` (2026-08-21, before Phase 0):**
```
...
A  V2_1_REPAIR_PLAN.md
A  V2_2_FINAL_CLEANUP_PLAN.md
A  V2_2_FINAL_FREEZE_PLAN.md
A  V2_2_REPAIR_PLAN.md
...
M  README.md
M  app_v2.py
M  configs/final_model_v2_2_fd004.yaml
A  configs/repository_integrity.yaml
A  conftest.py
A  experiments/v2_2/fd001_artifact_manifest.json
A  experiments/v2_2/fd004_artifact_manifest.json
A  experiments/v2_2/fd004_official_predictions.csv
M  pyproject.toml
A  reports/repository_integrity_implementation_report.md  (this file)
A  reports/repository_integrity_preservation_ledger.json
M  reports/v2_2_final_report.md
M  reports/v2_fd004.md
A  requirements-ci-linux-py312.txt
M  requirements-lock.txt
A  scripts/build_v2_2_artifact_manifests.py
M  scripts/build_v2_manifests.py
A  scripts/check_dependency_consistency.py
A  scripts/check_repository_integrity.py
M  scripts/run_v2_2_conformal.py
M  scripts/run_v2_2_fd004.py
M  scripts/run_v2_2_fd004_freeze.py
M  scripts/run_v2_2_fd004_posthoc.py
M  scripts/run_v2_2_posthoc.py
A  scripts/verify_v2_2_artifacts.py
A  src/rul_prediction/artifact_manifest.py
A  src/rul_prediction/benchmark/fd004_config.py
M  src/rul_prediction/benchmark/v2_2.py
M  src/rul_prediction/models/v2_models.py
A  src/rul_prediction/reproducibility.py
M  src/rul_prediction/serving/v2_predictor.py
A  tests/test_app_v2.py
...
M  tests/test_v2_1_fd004_condition.py
M  tests/test_v2_1_methodology.py
A  tests/test_v2_2_artifact_manifests.py
M  tests/test_v2_2_cleanup.py
A  tests/test_v2_2_fd004_config.py
M  tests/test_v2_2_protocol.py
M  tests/test_v2_conformal.py
M  tests/test_v2_features.py
M  tests/test_v2_manifests.py
M  tests/test_v2_preprocessing.py
M  tests/test_v2_serving.py
M  tests/test_validation.py
```
No model binaries (`models/v2_2/*.keras`, `*.joblib`), `data/raw`, `data/processed`, `.venv`, caches, or `session-ses_feb9.md` staged. `git diff --check` clean (only LF/CRLF warnings).

**Historical blob evidence (Phase 1):**
| File | `git hash-object` (working tree) | `git rev-parse 23cc934:<path>` | Match |
|---|---|---|---|
| `V2_1_REPAIR_PLAN.md` | `f5c1e7929ea2a5c7ea6f91337d21f2361f2c8803` | `f5c1e7929ea2a5c7ea6f91337d21f2361f2c8803` | True |
| `V2_2_REPAIR_PLAN.md` | `2631a59a4c6aa223c9da3ca970060c1072e1e90d` | `2631a59a4c6aa223c9da3ca970060c1072e1e90d` | True |
| `V2_2_FINAL_CLEANUP_PLAN.md` | `bbd55cd1e977330c08bf1162f52c812f78d3a7f9` | `bbd55cd1e977330c08bf1162f52c812f78d3a7f9` | True |
| `V2_2_FINAL_FREEZE_PLAN.md` | `2b82d835c07631518dee77430b7cd1f7e03cbdb5` | `2b82d835c07631518dee77430b7cd1f7e03cbdb5` | True |
...
- `reports/v2_2_final_report.md`, `reports/v2_fd004.md`, `AUDIT_V2.md` (reference/mojibake fixes)

**Sub-agent A — History / integrity:**
- `V2_1_REPAIR_PLAN.md`, `V2_2_REPAIR_PLAN.md`, `V2_2_FINAL_CLEANUP_PLAN.md`, `V2_2_FINAL_FREEZE_PLAN.md` (restored)
...
- Mojibake fixes: `CHANGELOG.md` (31 lines, 95 sequences: em/en dash, arrow, ellipsis, ×, ±, ², α, −, ≈, §, BOM, FFFD), `AUDIT_V2.md` (FFFD + 2 reference fixes), `tests/test_v2_2_cleanup.py` (BOM, §, path disambiguation)
...
- `configs/final_model_v2_2_fd004.yaml` (structured `optimizer: {name: adam, clipnorm: 1.0}`, header comment legacy_effective vs resolved, scopes clarified, numerics unchanged)
- `scripts/run_v2_2_fd004.py` (single `FD004_RECIPE`, atomic write, merge-by-variant, require 37*5 predictions)
- `scripts/run_v2_2_fd004_freeze.py` (delegated `load_and_validate_split`/`fit_fd004_final_model`/`save_fd004_final_artifacts`, fail-closed, atomic, no official labels)
- `scripts/run_v2_2_fd004_posthoc.py` (typed config, identical artifact paths, legacy adapter gate `f22ef...`, window=47 tensor check)
- `src/rul_prediction/models/v2_models.py` (`_optimizer` + `clipnorm` threading)
- `tests/test_v2_2_fd004_config.py` (new, 37 tests, 1 skipped valid sanity, 72 warnings)
...
- `src/rul_prediction/benchmark/v2_2.py` (delegated `git_provenance`/`source_tree_hash` to reproducibility, docstrings match behavior, no more `OSError: continue`, no filesystem `rglob`)
...
- `scripts/build_v2_2_artifact_manifests.py` (new, `--root`, `--generated-at`, `--check` deterministic, preserve timestamp)
- `scripts/verify_v2_2_artifacts.py` (new, `--mode tracked`/`full`, `--root`)
- `experiments/v2_2/fd001_artifact_manifest.json` (15093 bytes, 25 artifacts, 35 lineage edges, `historical_dirty_partial`)
- `experiments/v2_2/fd004_artifact_manifest.json` (9394 bytes, 14 artifacts, 16 edges, `historical_incomplete`, `config_file_sha256` vs `config_canonical_sha256` wording)
- `experiments/v2_2/fd004_official_predictions.csv` (7049 bytes, byte-identical to `reports/tables/v2_2_fd004_predictions.csv`, `sha256 3489efda…`)
- `src/rul_prediction/serving/v2_predictor.py`, `scripts/run_v2_2_conformal.py`, `scripts/run_v2_2_posthoc.py`, `scripts/run_v2_2_fd004_posthoc.py` (load-time `verify_before_load` gates)
- `tests/test_v2_2_artifact_manifests.py` (new, 28 tests, `tracked_artifacts`/`integration`/`unit`)
...
- `tests/test_v2_2_cleanup.py`, `tests/test_loader.py`, `tests/test_artifacts.py`, etc. (marker classification: 9 `unit`, 10 `static_contract`, 10 `tracked_artifacts` in cleanup; `integration+needs_artifacts` for artifact-backed)
...
**Sub-agent F — App:**
- `app_v2.py` (import-safe: `get_predictor()` lazy `V2Predictor`, all `st.*`/`load_test`/`predict_frame` inside `main()`, `if __name__=="__main__": main()`)
- `src/rul_prediction/serving/v2_predictor.py` (lazy `tensorflow` inside neural branch only)
- `tests/test_app_v2.py` (new, 9 tests, 5 `app_smoke` artifact-free + 1 `app_smoke+needs_artifacts` headless, subprocess isolation, no `ScriptRunContext` warning, no TF for XGBoost)

**Sub-agent A follow-up also:** fixed references in `reports/v2_2_final_report.md:333`, `reports/v2_fd004.md:119`, `scripts/build_v2_manifests.py:4` (case FD001).
...
|---|---|---|---|---|
| FD001 frozen model | `models/v2_2/fd001_xgb_w90_d6.joblib` | `23bd460cd447141d90fd045b863f1a33db02845b83ce9d4148791811ad5a9d6b` | `23bd460cd447141d90fd045b863f1a33db02845b83ce9d4148791811ad5a9d6b` | Unchanged |
| FD001 scaler | `models/v2_2/fd001_scaler.joblib` | `d1b02cfc7043de8e68f9dd71bc1a99efbcd2754a921a59524a431647d0371a48` | `d1b02cfc7043de8e68f9dd71bc1a99efbcd2754a921a59524a431647d0371a48` | Unchanged |
| FD004 frozen model | `models/v2_2/fd004_gru_w45_huber_condC.keras` | `9b39a059ea528b94f9d806533a69da596b7950254bbea1f11a232b2bb29ac87d` | `9b39a059ea528b94f9d806533a69da596b7950254bbea1f11a232b2bb29ac87d` | Unchanged |
| FD004 condition preprocessor | `models/v2_2/fd004_conditionC.joblib` | `f22ef7189cda906ee4ea92c37df625023f136abb3fcd8a0a74e3a0fdf8b4a328` | `f22ef7189cda906ee4ea92c37df625023f136abb3fcd8a0a74e3a0fdf8b4a328` | Unchanged, byte-identical, loads only via `sha==f22ef...` gated legacy adapter |
...
**Dirty semantics:**
- `whole_dirty` = any `git status --porcelain=v2 -z` entry (including non-execution docs, `session-ses_feb9.md`, `C_MAPSS_...md`).
...
**Historical metadata** (`experiments/v2_2/fd001_final_fit_metadata.json`, `fd004_final_fit_metadata.json`) remains historical and honest; no retroactive upgrade to new provenance schema. Future metadata will include schema version, run-start timestamp, commit, whole/execution dirty flags, status/diff hashes, `source_tree_hash`+algorithm+file count, execution hash, relevant untracked list, dirty reason/snapshot hash, config file/canonical hashes, split/cutoff raw + canonical hashes, constraints hash, Python/package versions, captured before fit and finalized atomically after save.
...
**FD004 lineage (14 artifacts, 16 edges):** final config, model, condition preprocessor, final metadata, split JSON, validation cutoff CSV, variant results/predictions, best epochs, canonical official predictions (`experiments/v2_2/fd004_official_predictions.csv`, 7049 bytes, `3489efda…` byte-identical to `reports/tables/v2_2_fd004_predictions.csv` report mirror), final metrics, constraints.
...
.\.venv\Scripts\python.exe scripts/build_v2_2_artifact_manifests.py --check
...
**Baseline:** `requirements-lock.txt` was Windows `pip freeze` Python 3.12.6 (160 lines) while V2.2 configs record Python 3.12.10 and CI floated `3.12`. Treated as pinned constraints unless cross-platform lock generated.
...
- Core versions vs V2.2 documented: `tensorflow 2.21.0`, `numpy 2.5.2`, `pandas 3.0.5`, `scikit-learn 1.9.0`, `xgboost 3.4.0`, `joblib 1.5.3`, `python 3.12.10` — all match `configs/final_model_v2_2_fd*_yaml` `software_versions`.
...
- `static_contract`: 40? (21 from `test_marker_audit` 5 + `test_dependency_consistency` 6 + `test_repository_integrity` 7 + `test_documentation_truth` 4 + `test_v2_2_cleanup` 10 + others) — **40 passed**
- `unit`: 159? (170 with 1 skipped valid sanity in `test_v2_2_fd004_config`) — **~159 passed, 1 skipped**
...
- **Full local:** `281` collected → **~280 passed, 1 skipped, 16 warnings** (Windows, 2026-08-21, `.venv` 3.12.10). See `pytest --collect-only` breakdown: `test_reproducibility` 21, `test_v2_2_fd004_config` 37, `test_v2_2_artifact_manifests` 28, etc.
...
- `tests/test_v2_2_cleanup.py` (required references, formerly 2 failed) → **29 passed** (including `test_required_tracked_local_references_exist` and `test_no_broken_master_cleanup_plan_references` now green; `git hash-object` verification passed)
- `tests/test_v2_2_fd004_config.py` → **36 passed, 1 skipped (valid sanity), 72 warnings** (`window=47` → `(1,47,features)` + `(1,47)` mask verified; freeze/posthoc identical artifact paths)
- `tests/test_reproducibility.py` → **21 passed** (all falsification cases, no `except OSError: continue`)
- `tests/test_v2_2_artifact_manifests.py` → **28 passed** (deterministic, tracked/full, tamper via temp `root`)
...
- `tests/test_app_v2.py` → **9 passed** (see Section 11)
...
if __name__ == "__main__":
    main()
```
Only lightweight imports at module scope (`pandas`, `streamlit`, `DATA_COLUMNS`, `load_test`, `RISK_SENSORS`); `predictor = get_predictor()` no longer at import. `V2Predictor.__init__` imports `tensorflow`/`keras` only in neural branch (`if _model_name not in ("rf","xgboost")`), XGBoost deployment uses `joblib` without TF init.

**Tests (`tests/test_app_v2.py`, 9 tests, `app_smoke`):**
- Artifact-free subprocess `import app_v2` succeeds; `main` and `get_predictor` exist
- Import does not construct predictor (spy on `V2Predictor.__init__` not called)
- Import does not open `models/v2_2/*` or `data/raw` (spy on `open`/`Path.open` empty)
- Import emits no `missing ScriptRunContext` or TF init output; `tensorflow`/`keras` not in `sys.modules`
- Friendly missing-artifact guidance appears only when `get_predictor()` actually requests model (raises `FileNotFoundError` with `run_v2_2_freeze.py` + `models` hint)
...
- `get_predictor()` returns `model_version=v2.2-xgb_w90_d6`, `window=90`, `candidate xgb`
- Headless `streamlit run app_v2.py --server.headless true --server.port <free>` stays alive >5s without crash, terminated cleanly; `test_headless_streamlit_smoke_with_artifacts` (`app_smoke` + `needs_artifacts`) **PASSED**; artifact-free import tier `app_smoke and not needs_artifacts` **8 passed**.
...
All falsification tests in `test_v2_2_protocol.py` (A–H), `test_v2_conformal.py`, `test_v2_2_cleanup.py` green.
...
- FD001/FD004 official labels permanently post-hoc (inspected in V2-0 audit; never sealed).
- Conformal interval calibrated on 15 engines held out from V2.2 fitting but inspected in earlier iterations → empirically calibrated, not pristine one-shot guarantee; simultaneous coverage ≥1−α only under engine exchangeability with predefined checkpoints; use on arbitrary trajectories is engineering extrapolation.
...
- Historical `V2_2_REPAIR_PLAN.md` retains 22 mojibake sequences (em/en dashes, arrows, etc.) by byte-identical requirement; `configs/repository_integrity.yaml` excepts it.
...
| RI-04 | High | Source hash includes ignored/generated files and is not fail-closed | Provenance (C) | DONE | `tracked_source_tree_details` via `git ls-files -z`, `cmapss-tracked-source-v1` length-delimited, fail-closed, 21 falsification tests, `git_provenance`/`source_tree_hash` in `benchmark/v2_2.py` delegated |
...
| RI-09 | Medium | `app_v2` performs model/UI/data work at import and initializes TF unnecessarily | App (F) | DONE | `import app_v2` side-effect free (subprocess), XGBoost no TF (`tensorflow not in sys.modules`), `main()`/`get_predictor()` exist, headless smoke `app_smoke+needs_artifacts` green |
| RI-10 | Medium | Tracked text contains mojibake/replacement-character corruption | History/integrity (A) | DONE | `check_text_encoding` strict UTF-8, rejects FFFD/mojibake (11 sequences), 95 occurrences fixed in `CHANGELOG.md` + `AUDIT_V2.md`/`test_v2_2_cleanup.py`; historical `V2_2_REPAIR_PLAN.md` excepted |
| RI-11 | Medium | Registered unit/integration markers are unused; artifact needs are inconsistently expressed | CI/test (E) | DONE | `pyproject.toml` 6 markers, `conftest.py` enforces exactly one primary, `test_marker_audit.py` 5 green, `needs_artifacts` supplemental, `test_v2_2_cleanup.py` per-function markers, no nested collection |
