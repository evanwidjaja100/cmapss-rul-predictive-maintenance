# V2.1 Conformal Prediction (FD001, engine-cluster calibration)

Date: 2026-08-15 · Repair plan R9/R10/R11 · Supersedes the V2-8 row-level
conformal interval (q = 24.10, n = 75 rows) in `reports/v2_conformal.md`.

## Calibration unit = engine

The V2-8 calibration treated the 5 lifecycle checkpoints of each calibration
...
mis-stated. V2.1 calibrates at the ENGINE level:
...
## Calibration (frozen FD001 model, reports/tables/v2_1_conformal_calibration.csv)
...
reports/tables/v2_1_conformal_q.csv).

## Held-out empirical coverage (reports/tables/v2_1_conformal_coverage.csv)
...
- q = 70.34 is wider than V2-8's 24.10 because it must cover the worst of
