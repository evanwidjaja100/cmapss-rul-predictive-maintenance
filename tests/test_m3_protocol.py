"""Methodology M3 protocol-regression tests (artifact-free, synthetic).

Covers M3_REPAIR_PLAN.md M3-1..M3-11:
...
def test_g_calibration_ids_absent_from_control_manifests():
    ...
    from rul_prediction.data.m2_splits import group_folds
