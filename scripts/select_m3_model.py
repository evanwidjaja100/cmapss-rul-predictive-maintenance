"""Methodology M3: apply the pre-specified selection policy to the CV results.

Mechanical application of the rule locked in M3_REPAIR_PLAN.md in the
recorded development session BEFORE the M3 CV comparison results were
...
configs/final_model_m3_fd001.yaml (model-type-specific: XGBoost candidates
...
Usage: python scripts/select_m3_model.py
"""
...
from rul_prediction.benchmark.m3 import (
    CV_CANDIDATES,
...
def _model_config(candidate: dict, duration: dict) -> dict:
    ...
    if arch == "xgboost":
        ...
        base["features"] = {
            ...
            "feature_extractor": "rul_prediction.features.m1_features.extract_m1_features",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Apply M3 selection policy")
    parser.add_argument("--config-out", default="configs/final_model_m3_fd001.yaml")
    ...
    cfg = {
        ...
        "splits": {
            ...
            "development_engine_manifest": "experiments/m3/fd001_outer_split_manifest.json",
            "calibration_engine_manifest": "experiments/splits/fd001_m3_calibration_cutoffs.csv",
            "development_engine_ids_sha256": split_manifest["development_engine_ids_sha256"],
            "calibration_engine_ids_sha256": split_manifest["calibration_engine_ids_sha256"],
            "outer_cv_manifest": "experiments/m3/fd001_outer_split_manifest.json",
            "canonical_hashes": {
        ...
        "selection": {
            ...
            "cv_results_csv": "experiments/m3/fd001_cv_summary.csv",
