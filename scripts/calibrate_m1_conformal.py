"""Phase M1-8: split-conformal calibration of the frozen model.
...
Evaluates, for alpha in (0.1, 0.2, 0.3):
  ...
  * the EARLY-WARNING value y_hat - q as a prediction: RMSE/MAE/NASA vs raw
    ...
    identified in Phase M1-6)

Writes:
    reports/tables/m1_conformal_calibration.csv  (tracked)
    experiments/m1_calibration_scores.csv        (gitignored)
    experiments/m1_conformal_intervals.csv       (gitignored, alpha=0.1)
"""
...
ALPHAS = (0.1, 0.2, 0.3)
RESULT_CSV = ROOT / "reports" / "tables" / "m1_conformal_calibration.csv"
SCORES_CSV = ROOT / "experiments" / "m1_calibration_scores.csv"
INTERVALS_CSV = ROOT / "experiments" / "m1_conformal_intervals.csv"
...
def main() -> None:
    ...
    cal_path = ROOT / "experiments" / "splits" / "fd001_m1_calibration_cutoffs.csv"
