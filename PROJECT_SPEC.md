...
| tests | 163 full local; real clean Git clone artifact-free `<clone counts inserted after QA run>`; `tests/test_v2_2_protocol.py` (Tests A–H) |
...
| 14 testing / CI | V2-10 (`tests/`, `.github/workflows/ci.yml`) | done (historical counts; current: 163 full local; real clean-clone QA `<clone counts inserted after QA run>`) |
